...
describe('Transaction', ()=>{
    ...
    beforeEach(() => {
        ...
        //recipient  is the publick key to the wallet being sent to
    ...
    describe('outputMap', () =>{
        ...
        it('outputs the remaining balance doe the `senderwallet` ', ()=>{
    ...
    describe('input', () => {
        ...
        it('sets the `address` ti the `senderWaller` publicKey ', () =>{
    ...
    describe('update()', ()=> {
        ...
        it('subtracts the amount fropm the original sender ouput amount', ()=>{
        ...
        describe('and another update for the same recipient', ()=>{
         ...
         senderWallet, recipient:nextRecipient, amount:addedAmount
            ...
            it('substract the amount from the original sender ooutput amount', ()=>{
                expect(transaction.outputMap[senderWallet.publicKey])
